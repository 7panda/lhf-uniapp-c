			...
			<block v-else>
				<view class="detail-swiper-selector">
					...
					<su-swiper class="ss-m-b-14" isPreview :list="state.goodsSwiper" dotStyle="tag" imageMode="widthFix"
						dotCur="bg-mask-40" :seizeHeight="450" />
					...
					<view class="title-card detail-card ss-p-y-40 ss-p-x-20">
						<view class="ss-flex ss-row-between ss-col-center ss-m-b-26">
							...
							<view
							  ...
							  v-if="(state.selectedSkuPrice.price > 0) || (state.goodsInfo?.product?.price > 0)"
							>
					...
					<view class="detail-cell-card detail-card ss-flex-col">
						<detail-cell-sku v-model="state.selectedSkuPrice.spData" :skus="state.goodsInfo.skus"
				...
				<!-- 详情 -->
				<detail-content-card class="detail-content-selector"
					:content="state.goodsInfo.product.detailMobileHtml" />
